defmodule Grav1Web.ProjectsLive do
  ...
  def handle_event("view_project", %{"id" => id}, socket) do
    case Repo.get(Project, id) do
      ...
      project ->
        {:noreply, socket |> assign(page: {live_component(socket, Grav1Web.ProjectComponent, id: "project:#{project.id}", project: project), :project})}
    end
  end
  ...
  def update(project) do
    Grav1Web.Endpoint.broadcast(@topic, "projects:update", %{project: project, projects: get_projects()})
  end
